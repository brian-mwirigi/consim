...
On Moore grids at size 48, PC1 \emph{without} \(R\) is 85.7\%, compared
to 85.0\% \emph{with} \(R\). Including \(R\) does not inflate the
collapse. Across all five scaling sizes, removing \(R\) changes PC1 by
less than 2 percentage points in either direction (size 12: 49.3\% vs
49.9\%; size 24: 68.7\% vs 66.7\%; size 48: 85.7\% vs 85.0\%). The
...
\textbf{Acknowledgment.} GitHub Copilot was used for code assistance during development.
